    ...
    [0], {
        1084: function(e, t, n) {
            (function(e) {
                ...
                }, n(1085), t.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== e && e.setImmediate || this && this.setImmediate, t.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== e && e.clearImmediate || this && this.clearImmediate
            }).call(this, n(88))
        },
        1085: function(e, t, n) {
            (function(e, t) {
            ...
            }).call(this, n(88), n(237))
        },
        653: function(e, t, n) {
            "use strict";
            (function(e, n) { /*! @vimeo/player v2.16.0 | (c) 2021 Vimeo | MIT License | https://github.com/vimeo/player.js */
                function r(e, t) {
                ...
                var b = ["autopause", "autoplay", "background", "byline", "color", "controls", "dnt", "height", "id", "keyboard", "loop", "maxheight", "maxwidth", "muted", "playsinline", "portrait", "responsive", "speed", "texttrack", "title", "transparent", "url", "width"];
                        ...
                        u.open("GET", i, !0), u.onload = function() {
                            if (404 !== u.status)
                                if (403 !== u.status) try {
                                    ...
                                    if (403 === t.domain_status_code) return E(t, n), void o(new Error("“".concat(e, "” is not embeddable.")));
                                    r(t)
                                } catch (e) {
                                    o(e)
                    ...
                    I = function() {
                        function e(t) {
                            ...
                            var a = new m((function(e, r) {
                                if (n._onMessage = function(t) {
                                    ...
                                    var i = k(t, o);
                                    T(s(i), i, t).then((function(e) {
                                        var r = E(e, t);
                                        return n.element = r, n._originalElement = t, w(t, r), F.set(n.element, n), e
                                    })).catch(r)
                                }
                            }));
                            if (N.set(this, a), F.set(this.element, this), "IFRAME" === this.element.nodeName && P(this, "ping"), C.isEnabled) {
                                var c = function() {
                                    return C.exit()
                                };
                                C.on("fullscreenchange", (function() {
                                    C.isFullscreen ? p(n, "event:exitFullscreen", c) : y(n, "event:exitFullscreen", c), n.ready().then((function() {
                                        P(n, "fullscreenchange", C.isFullscreen)
                                    }))
                                }))
                            }
                            return this
                        ...
                        return t = e, (n = [{
                            ...
                            value: function(e, t) {
                                ...
                                0 === g(this, "event:".concat(e)).length && this.callMethod("addEventListener", e).catch((function() {})), p(this, "event:".concat(e), t)
                            }
                        }, {
                            key: "off",
                            value: function(e, t) {
                            ...
                            key: "ready",
                            value: function() {
                                var e = N.get(this) || new m((function(e, t) {
                            ...
                            key: "getFullscreen",
                            value: function() {
                                return C.isEnabled ? m.resolve(C.isFullscreen) : this.get("fullscreen")
                            }
                        }, {
                            ...
                            value: function() {
                                ...
                                return new m((function(t) {
                                    if (N.delete(e), F.delete(e.element), e._originalElement && (F.delete(e._originalElement), e._originalElement.removeAttribute("data-vimeo-initialized")), e.element && "IFRAME" === e.element.nodeName && e.element.parentNode && (e.element.parentNode.parentNode && e._originalElement && e._originalElement !== e.element.parentNode ? e.element.parentNode.parentNode.removeChild(e.element.parentNode) : e.element.parentNode.removeChild(e.element)), e.element && "DIV" === e.element.nodeName && e.element.parentNode) {
            ...
            }).call(this, n(88), n(1084).setImmediate)
        }
    }
]);