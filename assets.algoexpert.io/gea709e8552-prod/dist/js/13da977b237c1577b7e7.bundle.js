                        ...
                        var i = {
                            set: function(n) {
                                var i = function(t, e, n) {
                                    var i = [P, L, j, z].concat(t._t, [C]);
                                    return {
                                        mutate: function(o) {
                                            for (var s = 0; s < i.length; s++) {
                                                var u = i[s];
                                                v(u) && v(u().modify) ? o = u(t, e, n).modify(o) : r("Transformer should be a function that returns an object with `modify()` method")
                                            }
                                            return o
                                        }
                                    }
                        ...
                        var i = new O,
                            ...
                            c = {
                                ...
                                bindSwipeStart: function() {
                                    var n = this,
                                        r = t.settings;
                                    r.swipeThreshold && i.on(W[0], e.Html.wrapper, (function(t) {
                                        n.start(t)
                                    }), a), r.dragThreshold && i.on(W[1], e.Html.wrapper, (function(t) {
                                        n.start(t)
                                    }), a)
                                },
